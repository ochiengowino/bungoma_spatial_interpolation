...
writeOGR(po, dsn = "/spatial_interpolation", layer = "po_Shapefile", driver = "ESRI Shapefile")
writeOGR(gadm, dsn = "/spatial_interpolation", layer = "gadm_Shapefile", driver = "ESRI Shapefile")
